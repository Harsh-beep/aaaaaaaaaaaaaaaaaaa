...
const start = async (aruga = new aruga()) => {
        ...
        console.log(color(figlet.textSync('Akeno Bot', { font: 'Ghost', horizontalLayout: 'default' })))
        console.log(color('------------------------------------------------------------------------', 'white'))
        console.log(color('[CREATOR]', 'aqua'), color('Harsh GT', 'magenta'))
        console.log(color('[BOT]', 'aqua'), color('Akeno BOT is now Online!', 'magenta'))
    ...
    aruga.onAddedToGroup(async (chat) => {
        await aruga.sendText(chat.groupMetadata.id, 'Thank you for adding Akeno Bot in your group')
    })
